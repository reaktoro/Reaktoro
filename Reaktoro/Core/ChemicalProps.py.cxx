...
void exportChemicalProps(py::module& m)
{
    py::class_<ChemicalProps>(m, "ChemicalProps")
        ...
        .def("serialize", py::overload_cast<ArrayXrConstRef>(&ChemicalProps::serialize), "Serialize chemical properties of the system.")
        .def("serialize", py::overload_cast<ArrayXrConstRef>(&ChemicalProps::serialize), "Serialize chemical properties of the system.")
        .def("deserialize", py::overload_cast<ArrayXrConstRef>(&ChemicalProps::deserialize), "Update the chemical properties of the system with serialized data.")
        .def("deserialize", py::overload_cast<ArrayXrConstRef>(&ChemicalProps::deserialize), "Update the chemical properties of the system with serialized data.")
